...
//Retorno
document.getElementById("volver").addEventListener('click', actualizar);
...
//Coleccion
document.getElementById("vercoleccion").addEventListener('click', eVerColec)
